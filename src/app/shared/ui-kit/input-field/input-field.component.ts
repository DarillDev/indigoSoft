...
import { FormFieldComponent, HintDirective, ErrorDirective, LabelDirective } from '@shared/ds/form-field';
...
export class InputFieldComponent extends AInputBaseControl<string> {
  ...
  public readonly id = input(`ui-input-field-${dsInputFieldNextId++}`);
